...
class ConfigClass(object):
    ...
    # Flask-Mail settings
    MAIL_USERNAME = os.getenv('MAIL_USERNAME', 'berniebd83@sohu.com')
    MAIL_PASSWORD = os.getenv('MAIL_PASSWORD', '1qaz@WSX')
    MAIL_DEFAULT_SENDER = os.getenv('MAIL_DEFAULT_SENDER', '"MyApp" <noreply@example.com>')
    MAIL_SERVER = os.getenv('MAIL_SERVER', 'smtp.sohu.com')
